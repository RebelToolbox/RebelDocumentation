...
on compiling Rebel Engine for each platform.
...
:doc:`C++ profilers </development/engine/using_cpp_profilers>` will also no longer be able to display
...
Rebel Engine allows compiling using size optimizations (instead of speed).
...
A lot of Rebel Engine's functions are offered as modules.
...
.. seealso::
    ...
    :ref:`development/compiling/introduction_to_the_buildsystem:overriding the build options`.
