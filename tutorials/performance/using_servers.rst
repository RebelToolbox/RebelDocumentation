...
In many cases, this is not really a problem (Rebel Engine is very optimized, and most operations are handled
...
Still, Rebel Engine is designed to work around this problem.

Servers
-------

One of the most interesting design decisions for Rebel Engine is the fact that the whole scene system is
*optional*. While it is not currently possible to compile it out, it can be completely bypassed.

At the core, Rebel Engine uses the concept of Servers. They are very low-level APIs to control
...
implementations of everything Rebel Engine allows you to do.
...
Most Rebel Engine nodes and resources contain these RIDs from the servers internally, and they can
