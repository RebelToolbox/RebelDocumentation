...
Containers provide a huge amount of layout power (as an example, Rebel Editor user interface is entirely done using them):
...
Rebel Engine provides several container types out of the box as they serve different purposes:
