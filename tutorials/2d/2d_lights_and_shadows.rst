...
``gradient length``. Rebel Engine supports `Percentage Closer Filtering <https://developer.nvidia.com/gpugems/gpugems/part-ii-lighting-and-shadows/chapter-11-shadow-map-antialiasing>`__
