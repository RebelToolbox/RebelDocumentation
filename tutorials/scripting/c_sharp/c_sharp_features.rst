...
For more advanced type checking, you can look into `Pattern Matching <https://learn.microsoft.com/dotnet/csharp/fundamentals/functional/pattern-matching>`__.
...
Signals support parameters and bound values of all the `built-in types <https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types>`__ and Classes derived from :ref:`Rebel.Object <class_Object>`.
