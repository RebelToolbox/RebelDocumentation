...
.. note:: If this is your first time encountering GDScript, please read
          :doc:`/getting_started/step_by_step/scripting_languages` before continuing.
...
.. tip:: If you've never used vector math before, or need a refresher, you can
         see an explanation of vector usage in Rebel Engine at :doc:`/tutorials/math/vector_math`.
...
enemies yet! That's OK, because we're going to use Rebel Engine's *signal*
...
settings so click "Connect" again. Rebel Editor will automatically create a function in
...
.. Note:: Disabling the area's collision shape can cause an error if it happens
          ...
          ``set_deferred()`` tells Rebel Engine to wait to disable the shape until it's
          safe to do so.
