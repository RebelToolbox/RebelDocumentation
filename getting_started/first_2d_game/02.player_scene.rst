...
Rebel Editor will display a warning icon next to the node in the scene tree. You can
...
.. note:: For this project, we will be following the Rebel naming conventions.

          - **GDScript**: Classes (nodes) use PascalCase, variables and
            functions use snake_case, and constants use ALL_CAPS (See
            :doc:`/tutorials/scripting/gdscript/gdscript_styleguide`).

          - **C#**: Classes, export variables and methods use PascalCase,
            private fields use _camelCase, local variables and parameters use
            camelCase (See :doc:`/tutorials/scripting/c_sharp/c_sharp_style_guide`). Be careful to type
